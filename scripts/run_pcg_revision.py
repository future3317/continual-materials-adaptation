"""Run the revision protocol with PCG."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="PCG revision protocol runner")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("reports/pcg_revision"))
    ...
    # Evaluate revised / unchanged / structure_revised subsets on the second endpoint.
