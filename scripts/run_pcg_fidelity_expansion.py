"""Run the fidelity-expansion protocol with PCG."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="PCG fidelity-expansion runner")
    parser.add_argument("--version", default="dft_3d_2021")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("reports/pcg_fidelity_expansion"))
