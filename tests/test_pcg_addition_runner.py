"""Smoke test for the PCG addition runner."""
...
from pcg_runner import cap_records, determine_parents_addition, run_pcg_protocol
from protocols import build_addition_protocol


@pytest.mark.slow
def test_addition_runner_smoke(tmp_path: Path):
    ...
    assert metrics["protocol"] == "addition"
